...
namespace Storyteller.Media
{
	public class FilterFactory
	{
		...
		private readonly FilterInfoProvider filterInfoProvider = new FilterInfoProvider();

		public IBaseFilter CreateFilter(FilterType filterType)
		{
			var guid = filterInfoProvider.GetGuid(filterType);
		...
		{
			var guid = filterInfoProvider.GetGuid(filterName);
