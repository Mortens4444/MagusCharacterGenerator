...
public class ObjectSerializer
{
	...
	{
		return JsonConvert.DeserializeObject<T>(fileContent, GetJsonSerializerSettings()) ?? throw new InvalidDataException($"Cannot deserialize {fileContent} to {typeof(T).FullName}");
	}
