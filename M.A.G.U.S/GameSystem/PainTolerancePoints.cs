...
{
    public static int Calculate(Character character, ISettings? settings)
    {
        ...
        {
            painTolerancePoints = doubledPainToleranceBase != null ? 2 * character.BaseClass.BasePainTolerancePoints : character.BaseClass.BasePainTolerancePoints;
