...
public class ThreeThieves : Poison
{
    ...
    public override string Description => "Level 10, multi-component poison. Of Krannish origin, its recipe reportedly comes from Krilehor himself, the thirteenth demigod of Kran. What is certain, however, is that its recipe is strictly secret—Player Characters are unlikely to know it. The first component is a food poison, the second a drink poison, and the third an airborne poison introduced into the system via candle smoke. When all three components are present, the effect is slow but permanent. The poison affects the muscular system (III.) and, in severe cases, results in total paralysis; in milder cases, it causes a weakness that never fades without the use of magic.";
