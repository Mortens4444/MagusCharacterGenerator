...
public class IronRider : Class, IClass, IJustFight
{
    private readonly List<Weapon> weapons =
    [
        RandomProvider.GetSecureRandomInt(0, 2) == 0 ? new BastardSword() : new OneHandedHatchet()
    ];

    public IronRider() : base(1, false) { }

    public IronRider(int level, bool autoGenerateSkills) : base(level, autoGenerateSkills) { }
    ...
    public override string Name => "Iron Rider";
    ...
    [
        ...
        new WeaponUse() { Weapon = new BastardSword() },
        new WeaponUse() { Weapon = new OneHandedHatchet() },
