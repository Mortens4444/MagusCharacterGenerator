...
public class ErigowianArcher : Class, IClass, IJustFight
{
    public ErigowianArcher() : base(1, false) { }

    public ErigowianArcher(int level, bool autoGenerateSkills) : base(level, autoGenerateSkills) { }
    ...
    [
        new WeaponUse(QualificationLevel.Master) { Weapon = new LightCrossbow() },
        new WeaponUse() { Weapon = new HeavyCrossbow() },
        new WeaponUse() { Weapon = new ShortSword() },
        new Swimming(),
