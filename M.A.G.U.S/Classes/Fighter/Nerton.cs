...
public class Nerton : Class, IClass, IJustFight
{
    public Nerton() : base(1, false) { }

    public Nerton(int level, bool autoGenerateSkills) : base(level, autoGenerateSkills) { }
    ...
    [
        ...
        new Juggling(QualificationLevel.Master, 3),
        new TavernBrawling(level: 3),
        new Wrestling(QualificationLevel.Master, 4),
        new WeaponUse(QualificationLevel.Master, level: 5),
        new Disarmament(QualificationLevel.Master, level: 6)
    ]);
