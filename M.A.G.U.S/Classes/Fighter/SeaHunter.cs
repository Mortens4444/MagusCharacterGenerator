...
public class SeaHunter : Class, IClass, IJustFight
{
    public SeaHunter() : base(1, false) { }

    public SeaHunter(int level, bool autoGenerateSkills) : base(level, autoGenerateSkills) { }
    ...
    public override string Name => "Sea Hunter";
