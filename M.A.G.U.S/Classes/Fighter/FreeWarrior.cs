...
public class FreeWarrior : Class, IClass, IJustFight
{
    public FreeWarrior() : base(1, false) { }

    public FreeWarrior(int level, bool autoGenerateSkills) : base(level, autoGenerateSkills) { }
    ...
    public override string Name => "Free Warrior";
    ...
    [
        new WeaponUse() { Weapon = new Ramiera() },
        new WeaponUse(),
        new WeaponUse(),
        new WeaponThrowing(),
        new Riding(),
        new Running(),
        new Backstab(),
        new ReligionLore() { Note = "Ranagol" },
        new Etiquette() { Note = "Gorvikian" }
    ]);
    ...
    [
        ...
        new Backstab(QualificationLevel.Master, level: 5),
