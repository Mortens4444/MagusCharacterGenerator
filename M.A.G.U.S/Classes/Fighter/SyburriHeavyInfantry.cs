...
public class SyburriHeavyInfantry : Class, IClass, IJustFight
{
    public SyburriHeavyInfantry() : base(1, false) { }

    public SyburriHeavyInfantry(int level, bool autoGenerateSkills) : base(level, autoGenerateSkills) { }
    ...
    public override string Name => "Syburri Heavy Infantry";
    ...
    [
        ...
        new Leadership() { Note = "Infantry" }
    ]);

    public override QualificationList FutureQualifications => BuildQualifications(
    [
        new ShieldUse(QualificationLevel.Master, 3),
        new MilitaryFormation(level: 4),
        new Leadership(QualificationLevel.Master, 5) { Note = "Infantry" },
        new HeavyArmorWearing(QualificationLevel.Master, 7),
    ]);
