...
public class WarriorSailor : Class, IClass, IJustFight
{
    public WarriorSailor() : base(1, false) { }

    public WarriorSailor(int level, bool autoGenerateSkills) : base(level, autoGenerateSkills) { }
    ...
    public override string Name => "Warrior-Sailor";
    ...
    [
        new Leadership(level: 3) { Note = "On sea" },
        new Knotting(QualificationLevel.Master, 3),
        new Cartography(level: 4),
        new WeatherDivination(QualificationLevel.Master, 5),
        new SeaSurvival(QualificationLevel.Master, 6),
        new Swimming(QualificationLevel.Master, 6),
        new Sailing(QualificationLevel.Master, 7),
        new Leadership(QualificationLevel.Master, 8) { Note = "On sea" }
    ]);
