...
public class AbasissiPhalanxWarrior : Class, IClass, IJustFight
{
    ...
    [
        ...
        new WeaponThrowing() { Weapon = new Spear() },
    ...
    [
        new WeaponUse(QualificationLevel.Master, 3) { Weapon = new Spear() },
        new MilitaryFormation(QualificationLevel.Master, 4),
        new Leadership(level: 4),
        new WeaponThrowing(QualificationLevel.Master, 6) { Weapon = new Spear() },
    ]);
