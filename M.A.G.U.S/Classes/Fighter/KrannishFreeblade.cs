...
public class KrannishFreeblade : Class, IClass, IJustFight
{
    public KrannishFreeblade() : base(1, false) { }

    public KrannishFreeblade(int level, bool autoGenerateSkills) : base(level, autoGenerateSkills) { }
    ...
    public override string Name => "Krannish Freeblade";
    ...
    [
        new PoisoningAndNeutralization(level: 2),
        new PsiKrannish(level: 4),
