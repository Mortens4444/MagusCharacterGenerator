...
public class ImperialMercenary : Class, IClass, IJustFight
{
    public ImperialMercenary() : base(1, false) { }

    public ImperialMercenary(int level, bool autoGenerateSkills) : base(level, autoGenerateSkills) { }
    ...
    public override string Name => "Imperial Mercenary";
    ...
    [
        ...
        new MilitaryFormation(QualificationLevel.Master, 5),
        new Leadership(QualificationLevel.Master, 6),
