...
public class GianagiHalberdier : Class, IClass, IJustFight
{
    public GianagiHalberdier() : base(1, false) { }

    public GianagiHalberdier(int level, bool autoGenerateSkills) : base(level, autoGenerateSkills) { }
    ...
    [
        new SteelBreastplate(), // + Helmet
        new Halberd(),
        new Longsword()
    ];

    public override string Name => "Gianagi Halberdier";
    ...
    [
        new WeaponUse(QualificationLevel.Master) { Weapon = new Halberd() },
    ...
    [
        //new Climbing(15, level: 3),
        new WeaponUse(QualificationLevel.Master, 4) { Weapon = new Longsword() },
