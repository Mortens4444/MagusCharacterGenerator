...
public class OrdanianFlameGuard : Class, IClass, IJustFight
{
    public OrdanianFlameGuard() : base(1, false) { }

    public OrdanianFlameGuard(int level, bool autoGenerateSkills) : base(level, autoGenerateSkills) { }
    ...
    public override string Name => "Ordanian Flame Guard";
    ...
    [
        new WeaponUse(), // kard
        new WeaponUse(), // szálfegyver
        new Swimming(),
        new Running(),
        new ReadingAndWriting(),
        new PsiPyarron(),
        new Sailing(),
        new ReligionLore() { Note = "Sogron" }
    ]);

    public override QualificationList FutureQualifications => BuildQualifications(
    [
        new ReligionLore(QualificationLevel.Master, 4) { Note = "Sogron" },
        //new FireMagic(QualificationLevel.Master, 6)
    ]);
    ...
    [
        new OrdanianFlameGuardFireMagic() // * Af
    ];
