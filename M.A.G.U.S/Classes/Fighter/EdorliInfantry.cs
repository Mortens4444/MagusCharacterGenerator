...
public class EdorliInfantry : Class, IClass, IJustFight
{
    public EdorliInfantry() : base(1, false) { }

    public EdorliInfantry(int level, bool autoGenerateSkills) : base(level, autoGenerateSkills) { }
    ...
    public override int DefenseBaseValue => 67;
    ...
    public override string Name => "Edorli Infantry";
    ...
    [
        ...
        new WeaponUse(),
        new Running(),
        new ShieldUse() // Pavéze
    ]);

    public override QualificationList FutureQualifications => BuildQualifications(
    [
        new WeaponUse(QualificationLevel.Master, 4), // Számszeríj
        new Leadership(level: 6) { Note = "Infantry" }
    ]);
