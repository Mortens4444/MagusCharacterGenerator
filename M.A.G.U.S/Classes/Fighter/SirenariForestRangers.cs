...
public class SirenariForestRangers : Class, IClass, IJustFight
{
    ...
    [
        ...
        new WeaponUse() { Weapon = new ElvenDagger() },
        new WeaponUse() { Weapon = new ElvenBow() },
    ...
    [
        ...
        new WeaponUse(QualificationLevel.Master, 3) { Weapon = new ElvenBow() },
        new TrapSetting(QualificationLevel.Master, 3),
        new Aiming(QualificationLevel.Master, 4),
        new Etiquette(level: 4),
