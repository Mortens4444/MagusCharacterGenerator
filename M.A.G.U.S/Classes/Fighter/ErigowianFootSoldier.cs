...
public class ErigowianFootSoldier : Class, IClass, IJustFight
{
    public ErigowianFootSoldier() : base(1, false) { }

    public ErigowianFootSoldier(int level, bool autoGenerateSkills) : base(level, autoGenerateSkills) { }
    ...
    public override string Name => "Erigowian Foot Soldier";
    ...
    [
        new WeaponUse(), // kétkezes fegyver
        new WeaponUse(),
        new WeaponUse(),
    ...
    [
        new MilitaryFormation(level: 3),
        new HeavyArmorWearing(QualificationLevel.Master, 5),
        new Leadership(level: 6) { Note = "Heavy infantry" }
    ]);
