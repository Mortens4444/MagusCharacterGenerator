...
public class Assassin : Class, IClass, IJustFight
{
    ...
    public override IRace[] AllowedRaces => [new Human(), new Elf(), new HalfElf(), new CourtOrc(), new Amund(), new Jann(), new Khal(), new Wier(), new Feenhar(), new Draquon(), new DarkElf(), new Faun()];
