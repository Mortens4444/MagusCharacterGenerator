...
public class DwoonHeavyInfantry : Class, IClass, IJustFight
{
    public DwoonHeavyInfantry() : base(1, false) { }

    public DwoonHeavyInfantry(int level, bool autoGenerateSkills) : base(level, autoGenerateSkills) { }
    ...
    public override string Name => "Dwoon Heavy Infantry";
    ...
    [
        ...
        new Swimming(),
        new Running(),
        new HeavyArmorWearing() //nehézvértviselethez 20 Kp Mf
    ]);

    public override QualificationList FutureQualifications => BuildQualifications(
    [
        new WeaponUse(level: 4),
        new Leadership(level: 4)
    ]);

    public override PercentQualificationList PercentQualifications =>
    [
        //new Jumping(10, level: 3)
    ];
