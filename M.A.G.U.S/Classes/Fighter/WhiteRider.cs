...
public class WhiteRider : Class, IClass, IJustFight
{
    public WhiteRider() : base(1, false) { }

    public WhiteRider(int level, bool autoGenerateSkills) : base(level, autoGenerateSkills) { }
    ...
    public override string Name => "White Rider";
    ...
    [
        ...
        new WeaponUse() { Weapon = new Saber() },
