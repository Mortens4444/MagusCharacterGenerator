...
public class ToronianSilverSwordChampion : Class, IClass, IJustFight
{
    public ToronianSilverSwordChampion() : base(1, false) { }

    public ToronianSilverSwordChampion(int level, bool autoGenerateSkills) : base(level, autoGenerateSkills) { }
    ...
    public override string Name => "Toronian Silver Sword Champion";
    ...
    // tudást tanúsító oklevél, valamint egy ezüstszín kard tetoválás

    public override QualificationList Qualifications => BuildQualifications(
    [
        new WeaponUse(), // hosszúkard vagy tőrkard
        new WeaponUse() { Weapon  = new Dagger() },
        new WeaponThrowing(QualificationLevel.Master) { Weapon  = new Dagger() },
        new Fistfight(),
        new TwoHandedCombat(),
    ...
    [
        ...
        new Heraldry(level: 3),
        new Disarmament(level: 5)
    ]);
