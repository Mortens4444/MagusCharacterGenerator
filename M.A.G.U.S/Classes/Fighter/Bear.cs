...
public class Bear : Class, IClass, IJustFight
{
    public Bear() : base(1, false) { }

    public Bear(int level, bool autoGenerateSkills) : base(level, autoGenerateSkills) { }
    ...
    public override string[] Images => ["yllinor_bear.png"];
    ...
    [
        new WeaponUse(QualificationLevel.Master) { Weapon = new OneHandedHatchet() },
        new ShieldUse(),
    ...
    [
        new ForestSurvival(QualificationLevel.Master, 3),
        new TrackingConcealment(QualificationLevel.Master, 4),
        new WeatherDivination(level: 5)
    ]);
