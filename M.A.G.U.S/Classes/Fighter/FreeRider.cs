...
public class FreeRider : Class, IClass, IJustFight
{
    public FreeRider() : base(1, false) { }

    public FreeRider(int level, bool autoGenerateSkills) : base(level, autoGenerateSkills) { }
    ...
    public override string Name => "Free Rider";
    ...
    [
        new WeaponUse() { Weapon = new LightLance() },
        new WeaponUse(),
    ...
    [
        new WeaponUse(QualificationLevel.Master, 4) { Weapon = new LightLance() },
        new ShieldUse(QualificationLevel.Master, 5),
