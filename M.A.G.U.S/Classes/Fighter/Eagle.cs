...
public class Eagle : Class, IClass, IJustFight
{
    public Eagle() : base(1, false) { }

    public Eagle(int level, bool autoGenerateSkills) : base(level, autoGenerateSkills) { }
    ...
    public override string[] Images => ["yllinor_eagle.png"];
    ...
    [
        new WeaponUse(QualificationLevel.Master) { Weapon = new NomadBow() },
        new WeaponUse() { Weapon = new Shortbow() },
        new WeaponUse(QualificationLevel.Master) { Weapon = new ShortSword() },
        new Fistfight(),
        new PsiPyarron(),
        new Swimming(),
        new Running(),
