using MAGUS.Assistant.Database;
...
internal static class MauiProgram
{
    ...
    public static MauiApp CreateMauiApp()
    {
        ...
        // No platform notification implementation on Windows in this build - register stub
        builder.Services.AddSingleton<INotificationService, Services.StubNotificationService>();
#elif IOS
    ...
    private static void OpenEmailClientWithError(Exception exception)
    {
        MainThread.BeginInvokeOnMainThread(() =>
        {
            _ = OpenEmailClientWithErrorAsync(exception);
        });
    }
    ...
    public static async Task OpenEmailClientWithErrorAsync(Exception exception)
    {
        try
        {
            ...
            await Email.Default.ComposeAsync(message).ConfigureAwait(true);
        }
        catch (Exception ex)
        {
            Debug.WriteLine($"Cannot open the email client: {ex}");
        }
    }
    ...
    private static void RegisterViewModels(MauiAppBuilder builder)
    {
        var viewModelTypes = new List<Type>
        {
            ...
            typeof(FireMageSpecializationViewModel),
    ...
    private static void RegisterPages(MauiAppBuilder builder)
    {
        var pageTypes = new List<Type>
        {
            ...
            typeof(FireMageSpecializationPage),
