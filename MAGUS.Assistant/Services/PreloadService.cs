...
internal sealed class PreloadService
{
    ...
    private Task LoadClassesAsync()
        => Task.Run(() =>
        {
            try
            {
                var items = "MAGUS.Classes".CreateInstancesFromNamespace<IClass>()
    ...
    private Task LoadRacesAsync()
        => Task.Run(() =>
        {
            try
            {
                var items = "MAGUS.Races".CreateInstancesFromNamespace<Race>()
    ...
    private Task LoadCreaturesAsync()
        => Task.Run(() =>
        {
            try
            {
                var items = "MAGUS.Bestiary".CreateInstancesFromNamespace<Creature>()
                    .OrderBy(c => Lng.Elem(c.Name))
                    .ToArray();
    ...
    private Task LoadThingsAsync()
        => Task.Run(() =>
        {
            try
            {
                var items = "MAGUS.Things".CreateInstancesFromNamespace<Thing>(typeof(INotForSale))
    ...
    private Task LoadGemstonesAsync()
        => Task.Run(() =>
        {
            try
            {
                var items = "MAGUS.Things.Gemstones".CreateInstancesFromNamespace<Gemstone>()
    ...
    private Task LoadRunesAsync()
        => Task.Run(() =>
        {
            try
            {
                var runes = "MAGUS.GameSystem.Runes".CreateInstancesFromNamespace<Rune>()
                    .OrderBy(r => r.Name)
                    .ToArray();
    ...
    private Task LoadPoisonsAsync()
        => Task.Run(() =>
        {
            try
            {
                var poisons = "MAGUS.Things.Poisons".CreateInstancesFromNamespace<Poison>()
    ...
    private Task LoadQualificationsAsync()
        => Task.Run(() =>
        {
            try
            {
                var qualifications = "MAGUS.Qualifications".CreateInstancesFromNamespace<Qualification>()
