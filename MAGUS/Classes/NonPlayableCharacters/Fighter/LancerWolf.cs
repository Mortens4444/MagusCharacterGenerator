...
public class LancerWolf : Class, IClass, IJustFight
{
    public LancerWolf() : base(1, false) { }

    public LancerWolf(int level, bool autoGenerateSkills) : base(level, autoGenerateSkills) { }
    ...
    public override string Name => "Lancer Wolf";
    ...
    [
        ...
        new WeaponUse(QualificationLevel.Master) { Weapon = new LightLance() },
        new PsiPyarron(),
        new Riding(),
        new Swimming(),
        new Running(),
