...
/// <summary>
/// Tűzféreg (Tűzvarázsló, Első Törvénykönyv p.286). Hatalmas tűzféreg jelenik meg, mely
/// szinte lehetetlenül védhető rohamtámadásokat intéz ellenfelei ellen. The rulebook summons
...
/// hence Power is null.
/// </summary>
public sealed class FireWorm : ISpell
{
    private readonly DiceThrow diceThrow = new();

    public string Name => "Fire worm";
    ...
    public int DurationInRounds => 16;
