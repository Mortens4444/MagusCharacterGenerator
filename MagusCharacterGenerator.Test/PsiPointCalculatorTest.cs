    ...
    public class PsiPointCalculatorTest
    {
        ...
        private static List<Tuple<Character, int>> GetTestData()
        {
            ...
            [
                ...
                new Tuple<Character, int>(new Character(addPsiOnFirstLevelSettings, "Vesryn", new Elf(), ClassCreator.GetClass(typeof(Headhunter), 5)), 20),
                new Tuple<Character, int>(new Character(addPsiOnFirstLevelSettings, "Teol", new Elf(), ClassCreator.GetClass(typeof(Headhunter), 6)), 24),
                ...
                new Tuple<Character, int>(new Character(doNotAddPsiOnFirstLevelSettings, "Polind", new Elf(), ClassCreator.GetClass(typeof(Headhunter), 5)), 17),
                new Tuple<Character, int>(new Character(doNotAddPsiOnFirstLevelSettings, "Luio", new Elf(), ClassCreator.GetClass(typeof(Headhunter), 6)), 21),
